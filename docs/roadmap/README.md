...
| SSH remote execution tool (agent SSH tới host bất kỳ chạy lệnh, không whitelist host, luôn qua approval gate) | 🔜 Spec draft, cần ADR trước khi code | [`docs/features/ssh-remote-execution-tool.md`](../features/ssh-remote-execution-tool.md) |
