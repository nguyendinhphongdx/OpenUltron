...
| Agent Execution Strategy (ReAct mặc định / Plan-Execute tuỳ chọn, chọn qua tab lúc tạo/sửa agent top-level) | ✅ Đã có, live-verify xong (2026-09-06) qua API thật + model Gemini thật | [`docs/features/agent-execution-strategy.md`](../features/agent-execution-strategy.md), [ADR-0021](../adr/0021-agent-execution-strategy.md) |
| SSH remote execution tool (agent SSH tới host bất kỳ chạy lệnh, không whitelist host, luôn qua approval gate) | ✅ Đã có, live-verify qua API thật (2026-09-06) — còn thiếu verify tới 1 host SSH thật sự tồn tại (cần máy thật) | [`docs/features/ssh-remote-execution-tool.md`](../features/ssh-remote-execution-tool.md), [ADR-0022](../adr/0022-ssh-remote-execution-tool.md) |
